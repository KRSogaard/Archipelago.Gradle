...
#declare -a services=("auth-service" "harbor-service" "build-server-api" "build-server-builder" "version-set-service" "package-service")
 declare -a services=("build-server-builder")
...
for service in ${services[@]}; do
     ...
     docker tag build.archipelago/$service:latest 075174350620.dkr.ecr.us-west-2.amazonaws.com/$service:20210328-2
     docker push 075174350620.dkr.ecr.us-west-2.amazonaws.com/$service:20210328-2
done
